...
const TEAM_LOGOS: { [key: string]: string[] } = {
  ...
  'Liverpool': ['https://logos-world.net/wp-content/uploads/2020/06/Liverpool-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/7889.png'],
  'Liverpool FC': ['https://logos-world.net/wp-content/uploads/2020/06/Liverpool-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/7889.png'],
  'Manchester United': ['https://logos-world.net/wp-content/uploads/2020/06/Manchester-United-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/52683.png'],
  'Manchester United FC': ['https://logos-world.net/wp-content/uploads/2020/06/Manchester-United-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/52683.png'],
  ...
  // Bundesliga
  'Bayern Munich': ['https://logos-world.net/wp-content/uploads/2020/06/Bayern-Munich-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/50037.png'],
  'Borussia Dortmund': ['https://logos-world.net/wp-content/uploads/2020/06/Borussia-Dortmund-Logo.png', 'https://img.uefa.com/imgml/TP/teams/logos/50x50/52758.png'],
...
function getTeamLogos(team: string | { name: string; crest?: string }, apiLogoUrl?: string): string[] {
  ...
  // Priority order: 1. API logo, 2. Team object crest, 3. Local files, 4. CDN logos
  const logos: string[] = [];
  ...
  // Second priority: Team object crest
...
export const TeamLogo = ({ team, size = 40, className = '', logoUrl }: TeamLogoProps) => {
  ...
  return (
    <img
      ...
      className={`rounded-full object-cover flex-shrink-0 bg-white p-1 border border-border/20 ${className}`}
